...
// Mostrar equipos de una liga específica (Liga de Fútbol Profesional)
        ...
        for (Equipo equipo : equipoService.obtenerEquiposDeLiga(liga1.getId())) {
            // Asegúrate de obtener el entrenador asociado a cada equipo
            Entrenador entrenador = equipo.getEntrenador(); // Suponiendo que tienes la relación correctamente configurada
